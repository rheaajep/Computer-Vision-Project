...
# Read the image
im = imageio.imread('/home/geekerlink/Desktop/Computer Vision/hw1/hw1/data/mug.jpg')
...
plt.savefig('/home/geekerlink/Desktop/Computer Vision/hw1/hw1/results/transformed.png')
plt.show()
